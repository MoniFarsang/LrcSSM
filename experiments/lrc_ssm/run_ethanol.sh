...
# EthanolConcentration dataset parameters
NINPS=2 # ethanol has 2 input channels, don't change this
NCLASS=4 # ethanol has 4 classes, don't change this
NSEQUENCE=1751 # ethanol has 1751 sequence length, don't change this

# Run an individual training run with the following parameters
DATASET=ethanol_2345 # dataset split to use, change this to ethanol_3456, ethanol_4567, ethanol_5678, or ethanol_6789 for other splits
